...
class HelloTriangle {
  public:
    ...
    void Run() {
        ...
        while (window_pool_events(window.get())) {
            gal::acquire_next_image(context, swap_chain, swap_chain_signal_semaphore, swap_chain_present_fence, 0u);
            ...
            gal::cmd_set_scissor(command_list, 0, 0, width, height);
            gal::cmd_set_viewport(command_list, 0, 0, width, height, 0, 1);
            ...
            present_desc.swap_chain = swap_chain;
  ...
  private:
    ...
    gal::gal_semaphore swap_chain_signal_semaphore;
    gal::gal_fence swap_chain_present_fence;
    struct vertex {
