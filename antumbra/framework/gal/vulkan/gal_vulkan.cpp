...
gal_error_code vk_init_gal(gal_context *context) {
    vk_context *vk_ctx = ante::memory::alloc<vk_context>();
    if (vk_ctx == gal_null) {
        return gal_error_code::ERR;
    }
...
gal_error_code vk_create_instance(gal_desc *gal_desc, gal_context *context) {
    ...
    ante::vector<const char *> required_instance_layers;
    ante::vector<const char *> required_instance_extensions;
    ...
    ante::vector<VkLayerProperties> available_layers(available_layer_count);
    ante::vector<VkExtensionProperties> available_extensions(available_extension_count);
...
gal_error_code vk_create_device(gal_desc *gal_desc, gal_context *context) {
    ...
    ante::vector<const char *> required_device_extensions;
    ante::vector<const char *> required_device_layers;
    ...
    ante::vector<VkPhysicalDevice> physical_devices(physical_device_count);
    ...
    auto pick_gpu = [&](ante::fixed_array<u32, 3> &queue_family_indices) -> gal_error_code {
        for (const auto &physical_device : physical_devices) {
            ...
            ante::vector<VkQueueFamilyProperties> queue_family_properties(queue_family_count);
            ...
            ante::vector<VkLayerProperties> available_device_layers(available_layer_count);
            ...
            ante::vector<VkExtensionProperties> available_device_extensions(available_extension_count);
    ...
    ante::set<u32> queue_family_indices_set(queue_family_indices.begin(), queue_family_indices.end());
    ante::vector<VkDeviceQueueCreateInfo> device_queue_create_info(queue_family_indices_set.size());
    u32 idx = 0;
...
gal_error_code vk_create_buffer(gal_context context, gal_buffer_desc *desc, gal_buffer *buffer) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_buffer *vk_buf = ante::memory::alloc<ante::gal::vk_buffer>();
    if (vk_buf == nullptr) {
        return gal_error_code::ERR;
    }
...
gal_error_code vk_create_texture(gal_context context, gal_texture_desc *desc, gal_texture *texture) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_texture *vk_tex = ante::memory::alloc<ante::gal::vk_texture>();
...
gal_error_code vk_create_sampler(gal_context context, gal_sampler_desc *sampler_desc, gal_sampler *sampler) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_sampler *vk_spl = ante::memory::alloc<ante::gal::vk_sampler>();
...
gal_error_code vk_create_render_target(gal_context context, gal_render_target_desc *desc,
    ...
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_render_target *vk_rt = ante::memory::alloc<vk_render_target>();
...
gal_error_code vk_create_swap_chain(gal_context context, gal_swap_chain_desc *desc, gal_swap_chain *swap_chain) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_swap_chain *vk_sc = ante::memory::alloc<vk_swap_chain>();
...
#error PLATFORM NOT SUPPORTED
    ...
    ante::vector<VkSurfaceFormatKHR> formats;
    ...
    ante::vector<VkPresentModeKHR> modes;
    ...
    ante::fixed_array<VkPresentModeKHR, preferredModeCount> preferredModeList = {
    ...
    ante::fixed_array<VkCompositeAlphaFlagBitsKHR, 4> compositeAlphaFlags = {
...
gal_error_code vk_create_shader_program(gal_context context, gal_shader_program_desc *desc,
    ...
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_shader_program *vk_sp = ante::memory::alloc<ante::gal::vk_shader_program>();
    if (vk_sp == nullptr) {
        return gal_error_code::ERR;
    }
...
gal_error_code vk_create_pipeline_cache(gal_context context, gal_pipeline_cache_desc *desc,
    ...
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_pipeline_cache *vk_pc = ante::memory::alloc<ante::gal::vk_pipeline_cache>();
    if (vk_pc == nullptr) {
        return gal_error_code::ERR;
    }
...
gal_error_code vk_create_compute_pipeline(gal_context context, gal_pipeline_desc *desc, gal_pipeline *pipeline) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_pipeline *vk_pipe = ante::memory::alloc<ante::gal::vk_pipeline>();
...
gal_error_code vk_create_graphics_pipeline(gal_context context, gal_pipeline_desc *desc, gal_pipeline *pipeline) {
    ...
    ante::fixed_array<VkVertexInputBindingDescription, MAX_VERTEX_BINDINGS> input_bindings{};
    u32 input_attribute_count = 0;
    ante::fixed_array<VkVertexInputAttributeDescription, MAX_VERTEX_ATTRIBS> input_attributes{};
    ...
    ante::fixed_array<VkPipelineColorBlendAttachmentState, MAX_RENDER_TARGET_ATTACHMENTS> cbAtt{};
    ...
    ante::fixed_array<VkDynamicState, 5> dyn_states = {
...
gal_error_code vk_get_descriptor_set(gal_context context, gal_descriptor_set_desc *desc, u32 set_count,
    ...
    //vk_descriptor_set *vk_ds = ante::memory::alloc<ante::gal::vk_descriptor_set>();
    ...
    vk_descriptor_set *vk_ds = static_cast<ante::gal::vk_descriptor_set *>(
        ante::memory::amalloc(set_count * sizeof(ante::gal::vk_descriptor_set)));
    if (vk_ds == nullptr) {
        return gal_error_code::ERR;
    }

    
    ante::vector<VkDescriptorSet> vk_sets;
    for (u32 i = 0; i < set_count; i++) {
        vk_sets.push_back(vk_ds[i].set);
    }
    ante::vector<VkDescriptorSetLayout> set_layouts;
    ...
    vk_descriptor_pool *vk_dp = ante::memory::alloc<vk_descriptor_pool>();
...
gal_error_code vk_update_descriptor_set(gal_context context, gal_descriptor_set_update_desc *update_desc,
    ...
    ante::vector<VkDescriptorUpdateData> descriptor_updates;
...
gal_error_code vk_create_root_signature(gal_context context, gal_root_signature_desc *desc,
    ...
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_root_signature *vk_rs = ante::memory::alloc<ante::gal::vk_root_signature>();
    if (vk_rs == nullptr) {
        return gal_error_code::ERR;
    }
    ...
    ante::vector<VkDescriptorSetLayoutBinding> bindings;
    //ante::vector<u32> binding_prefix_sum(refl->sets.size(), );
    ante::vector<u32> binding_offsets(refl->sets.size());
    u32 total_binding_count = 0;
    ante::map<u32, u32> set_index_map;
    ...
    ante::vector<VkPushConstantRange> push_constants;
    ...
    ante::vector<ante::hash_map<VkDescriptorType, u32>> pool_sizes;
    ...
    //ante::vector<VkDescriptorUpdateTemplateEntry> descriptor_update_template_entries();
    //descriptor_update_template_entries.resize(total_binding_count);
    ante::vector<ante::vector<VkDescriptorUpdateTemplateEntry>> descriptor_update_template_entries;
...
gal_error_code vk_create_fence(gal_context context, gal_fence *fence) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_fence *vk_f = ante::memory::alloc<vk_fence>();
    if (vk_f == nullptr) {
        return gal_error_code::ERR;
    }
...
gal_error_code vk_wait_fences(gal_context context, gal_fence *fences, u32 count) {
    ...
    ante::vector<VkFence> submit_fences;
...
gal_error_code vk_create_semaphore(gal_context context, gal_semaphore *semaphore) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_semaphore *vk_s = ante::memory::alloc<vk_semaphore>();
    if (vk_s == nullptr) {
        return gal_error_code::ERR;
    }
...
gal_error_code vk_create_command_pool(gal_context context, gal_command_pool_desc *desc,
    ...
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_command_pool *vk_cmd_pool = ante::memory::alloc<ante::gal::vk_command_pool>();
...
gal_error_code vk_get_command_list(gal_context context, gal_command_list_desc *desc, gal_command_list *command) {
    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    vk_command_list *vk_cmd = ante::memory::alloc<ante::gal::vk_command_list>();
...
gal_error_code vk_cmd_resource_barrier(gal_command_list command, u32 buffer_barrier_count,
    ...
    ante::vector<VkBufferMemoryBarrier> bbs;
    ...
    ante::vector<VkImageMemoryBarrier> tbs;
...
gal_error_code vk_cmd_bind_vertex_buffer(gal_command_list command, u32 vertex_buffer_count, gal_buffer *vertex_buffers,
                                         [[maybe_unused]] u32 *strides, u64 *offsets) {
    vk_command_list *vk_cmd = reinterpret_cast<vk_command_list *>(command);
...
gal_error_code vk_cmd_draw_indexed_instanced(gal_command_list command, u32 index_count, u32 first_index,
    ...
    vkCmdDrawIndexed(vk_cmd->m_command, index_count, instance_count, first_index, static_cast<i32>(first_vertex),
                     first_instance);
    return gal_error_code::SUC;
}
...
gal_error_code vk_cmd_update_subresources(gal_command_list command, gal_texture dst, gal_buffer src,
    ...
    ante::vector<VkBufferImageCopy> regions(subresource_count);
...
gal_error_code vk_add_queue(gal_context context, gal_queue_desc *desc, gal_queue *queue) {
    ...
    vk_queue *vk_q = ante::memory::alloc<ante::gal::vk_queue>();
    if (vk_q == nullptr) {
        return gal_error_code::ERR;
    }
    *vk_q = *t_queue;
...
gal_error_code vk_queue_submit(gal_queue queue, gal_queue_submit_desc *desc) {
    ...
    ante::vector<VkCommandBuffer> cmds;
    for (u32 i = 0; i < cmdCount; ++i) {
        cmds.push_back(reinterpret_cast<vk_command_list *>(ppCmds[i])->m_command);
    }

    ante::vector<VkSemaphore> wait_semaphores;
    ante::vector<VkPipelineStageFlags> wait_masks;
    ...
    ante::vector<VkSemaphore> signal_semaphores;
