...
TEST_CASE("test gal buffer") {
    auto buffer_creation = [](gal::RenderApi api) {
        ...
        gal::buffer_desc desc{};
        desc.size = 256;
        desc.initial_state = gal::resource_state::rs_rw_buffer;
        desc.resource_types = gal::resource_type::rt_constant_buffer | gal::resource_type::rt_rw_buffer |
                              gal::resource_type::rt_indirect_buffer;
        desc.memory_flags = gal::memory_flag::gpu_dedicated;
        desc.flags = gal::buffer_creation_flag::bcf_own_memory;
        gal::buffer buffer{};
