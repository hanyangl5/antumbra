...
TEST_CASE("test gal buffer") {
    auto buffer_creation = [](gal::gal_api api) {
        ...
        desc.resource_types = gal::gal_descriptor_type::CONSTANT_BUFFER | gal::gal_descriptor_type::RW_BUFFER |
...
TEST_CASE("test gal texture") {
    auto texture_creation = [](gal::gal_api api) {
        ...
        texture_desc.resource_types = gal_descriptor_type::TEXTURE | gal_descriptor_type::RW_TEXTURE;
...
TEST_CASE("test gal render target") {
    auto sampler_creation = [](gal::gal_api api) {
        ...
        desc.resource_types = gal_descriptor_type::COLOR_RT;
